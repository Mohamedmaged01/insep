...
<div x-data="batchesManager()">
    ...
    <form method="GET" class="relative mb-6">
        ...
        <input type="text" name="q" value="{{ request('q') }}" placeholder="{{ $isAr ? 'بحث باسم المجموعة أو الدورة أو المدرب... واضغط Enter' : 'Search batch / course / trainer... press Enter' }}"
        ...
        @if(request('q'))<a href="{{ url()->current() }}" class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-red-500" title="{{ $isAr ? 'مسح' : 'Clear' }}">✕</a>@endif
    </form>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" x-cloak x-transition
                                        class="absolute left-0 top-full mt-1 w-44 bg-white rounded-xl shadow-xl border border-gray-100 py-1 z-30">
