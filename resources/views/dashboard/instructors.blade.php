...
<div x-data="instructorsManager()">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
            ...
            <p class="text-gray-500 text-sm">{{ $isAr ? 'إجمالي' : 'Total' }} {{ $instructors->count() }} {{ $isAr ? 'مدرب' : 'trainers' }}</p>
        </div>
    ...
    <div class="bg-white rounded-2xl p-4 mb-6 border border-gray-100">
        <div class="relative">
            ...
            <input type="text" x-model="search" placeholder="{{ $isAr ? 'بحث عن مدرب...' : 'Search for a trainer...' }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl pr-10 pl-4 py-2.5 text-sm">
        </div>
    </div>
