    ...
    <div class="bg-navy text-white py-2.5">
        <div class="container mx-auto px-4 flex justify-between items-center text-sm">
            <div class="flex items-center gap-4">
                <a href="tel:01033330027" class="flex items-center gap-1.5 hover:text-red-brand transition-colors duration-300">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg>
                    <span style="font-family: 'Roboto', sans-serif; direction: ltr" class="text-xs">01033330027</span>
                </a>
                <a href="tel:01030033090" class="hidden md:flex items-center gap-1.5 hover:text-red-brand transition-colors duration-300">
                    <span style="font-family: 'Roboto', sans-serif; direction: ltr" class="text-xs">01030033090</span>
                </a>
                <a href="tel:0222900951" class="hidden lg:flex items-center gap-1.5 hover:text-red-brand transition-colors duration-300">
                    <span style="font-family: 'Roboto', sans-serif; direction: ltr" class="text-xs">0222900951</span>
                </a>
                <a href="mailto:info@insep.net" class="hidden sm:flex items-center gap-1.5 hover:text-red-brand transition-colors duration-300">
                    ...
                    <span style="font-family: 'Roboto', sans-serif" class="text-xs">info@insep.net</span>
                </a>
            </div>
            <div class="flex items-center gap-2">
                ...
                <a href="https://twitter.com/insep_pro" target="_blank" rel="noopener noreferrer" class="w-7 h-7 rounded-full bg-white/10 flex items-center justify-center hover:bg-red-brand transition-all duration-300 hover:scale-110">
                ...
                <a href="https://t.me/insep_pro" target="_blank" rel="noopener noreferrer" class="w-7 h-7 rounded-full bg-white/10 flex items-center justify-center hover:bg-red-brand transition-all duration-300 hover:scale-110">
