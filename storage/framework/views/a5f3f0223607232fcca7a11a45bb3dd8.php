    ...
    <nav class="bg-white relative" x-data="{ mobileMenuOpen: false, searchOpen: false, servicesOpen: false }">
            ...
            <div class="hidden lg:flex items-center gap-1">
                ...
                <div class="relative" @mouseenter="servicesOpen = true" @mouseleave="servicesOpen = false">
                    ...
                    <div x-show="servicesOpen" x-cloak x-transition class="absolute top-full right-0 bg-white shadow-2xl rounded-xl py-2 w-56 border border-gray-100 z-50">
                        <a href="<?php echo e(route('verify')); ?>" class="flex items-center gap-3 w-full text-right px-4 py-3 hover:bg-navy/5 text-navy transition-colors">
                            ...
                            <span class="font-medium"><?php echo e($lang === 'ar' ? 'استعلام الشهادات' : 'Certificates Lookup'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div x-show="mobileMenuOpen" x-cloak x-transition class="lg:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-1 shadow-xl">
            <?php $__currentLoopData = [
                ...
                <a href="<?php echo e(route($item['route'])); ?>" class="block w-full text-right px-4 py-3 rounded-xl font-semibold transition-all <?php echo e(request()->routeIs($item['route']) ? 'bg-navy text-white' : 'text-navy hover:bg-gray-50'); ?>">
                    <?php echo e($item['label']); ?>
...
<?php /**PATH H:\insep\backend-laravel\resources\views/partials/header.blade.php ENDPATH**/ ?>